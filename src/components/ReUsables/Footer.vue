...
<section class="services">
    <ul> 
        <li>
            <img src="./../../images/shipment.gif" alt="shipment">
            <div class="texts">
                <p>Free Shipping</p>
                <span>Free shipping for order above $180</span>
            </div>
        </li>
        <li>
...
<footer>
    <div class="container">
    <span>Copyright &copy; 2024 Car Website Design. All Rights Reserved.</span>
    <div class="languages">
        <div class="links">
            <p>English</p>
